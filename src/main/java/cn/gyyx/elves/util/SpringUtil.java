...
public class SpringUtil {
	...
	/**spring文件的目录地址*/
	public static String SPRING_CONFIG_PATH=null;
	
	/**mybatis文件的目录地址*/
	public static String MYBATIS_CONFIG_PATH=null;
	
	/**rabbitmq文件的目录地址*/
	public static String RABBITMQ_CONFIG_PATH=null;
	
	/**conf.properties文件的目录地址*/
	public static String PROPERTIES_CONFIG_PATH=null;
	
	/**log4j配置文件的目录地址*/
	public static String LOG4J_CONFIG_PATH=null;
